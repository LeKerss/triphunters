...
class myActivityTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = listActivty[indexPath.row].nameActivity
        cell.detailTextLabel!.text = listActivty[indexPath.row].typeActivity.name()
        cell.imageView?.image = listActivty[indexPath.row].imageDesc[0]
        
        return cell
    }
    
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        activitySelected = listActivty[indexPath.row]
