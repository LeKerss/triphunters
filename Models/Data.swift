...
var allActivities = [
    ...
    Activity(idActivity: 8, idUser: 5, nameActivity: "La Clairière", descriptionActivity: "Concerts, danse et cocktails dans un cadre verdoyant avec des food-trucks bio disséminés parmi les arbres.", typeActivity: .NightLife, adresse: "1 Rue de Longchamp, 75116 Paris", country: "FranceTest", gpsx: 48.862725, gpsy: 2.287592, showActivity: true, imageDesc: [UIImage(named: "Clairiere1")!, UIImage(named: "Clairiere2")!, UIImage(named: "Clairiere3")!, UIImage(named: "Clairiere4")!]),
